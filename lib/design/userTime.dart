...
class Usertime extends StatefulWidget {
  const Usertime({Key? key}) : super(key: key);

  @override
  State<Usertime> createState() => _UsertimeState();
}

class _UsertimeState extends State<Usertime> {
  List<User> _users = [];
    ...
    return Scaffold(
            ...
            child: ListTile(
              ...
              subtitle: Column(
                ...
                children: [
                  ...
                  Text('Dernier accés : ${_users[index].time}',style: TextStyle(fontSize: 14),),
                ],
              ),
              trailing: Row(
                ...
                children: [
                  ...
                  IconButton(
                    icon: Icon(Icons.history ,size: 30,color: Colors.indigoAccent,),
                    onPressed: () {
                      if (_users[index].name == 'Houssine Ben Arous') {
                        Navigator.push(
                          context,
                      ...
                      else if (_users[index].name == 'Baha Eddine Dridi') {
                        Navigator.push(
                          context,
      ...
      floatingActionButton: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => addusertime()),
          );
        },
