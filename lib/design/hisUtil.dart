...
class his extends StatelessWidget {
  final List<Bloc> blocs = [    Bloc(      imagePath: 'assets/images/houssine.png', title: 'Houssine Ben Arous',    ),
    ...
    Bloc(      imagePath: 'assets/images/inconnu.png',      title: 'Samir Ben Mahmoud',    ),
                  ...
                  ElevatedButton(
                    onPressed: () {
                      if (bloc.title == 'Houssine Ben Arous') {
                        ...
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => PersonPage(imageUrl: 'assets/images/houssine.png', Prenom: 'Houssine', Nom: 'Ben Arous', email: 'Houssinebenarous48@gmail.com', Adresse: 'Marsa ,Sidi Daouad', Telephone: '+216 29.678.226', jobTitle: 'Student', diplome: 'Licence Systéme embarque et mobile',)
                          ),
                        );
                      } else if (bloc.title == 'Baha Eddine Dridi') {
                        Navigator.push(
                          context,
                          MaterialPageRoute(builder: (context) => PersonPage(imageUrl: 'assets/images/baha.png', Prenom: 'Baha', Nom: 'Eddine Dridi', email: 'BahaEddine441@gmail.com', Adresse: 'Marsa ,Sidi Daouad', Telephone: '+216 24.509.366', jobTitle: 'Student', diplome: 'Licence Systéme embarque et mobile',)
                          ),
                        );
                      }
