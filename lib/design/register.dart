...
class registerpag extends StatefulWidget {
  const registerpag({Key? key}) : super(key: key);

  @override
  State<registerpag> createState() => _registerpagState();
}
...
class _registerpagState extends State<registerpag> {
  ...
  Future<void> signup() async {
    ...
    final url = Uri.parse('http://192.168.239.126/flutter-login-signup/register.php');
